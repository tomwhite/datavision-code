...
# From https://github.com/cybercom-finland/location_tracking_ml/blob/master/load_data.py
def load_data(input_file):
    ...
    count = 0
    with open(input_file, 'r') as inputData:
...
if __name__ == "__main__":
    ...
    input_file = "data/tr-ft.json"
    output_file = "data/tr-ft-processed.json"

    position_tracks = load_data(input_file)
    with open(output_file, 'w') as outfile:
        json.dump(position_tracks, outfile)
